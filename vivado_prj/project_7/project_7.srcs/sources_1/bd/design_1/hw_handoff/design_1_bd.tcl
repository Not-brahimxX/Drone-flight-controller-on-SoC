...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set TTC0_WAVE0_OUT [ create_bd_port -dir O TTC0_WAVE0_OUT ]
  set TTC0_WAVE1_OUT [ create_bd_port -dir O TTC0_WAVE1_OUT ]
  set TTC0_WAVE2_OUT [ create_bd_port -dir O TTC0_WAVE2_OUT ]
  set TTC1_WAVE0_OUT [ create_bd_port -dir O TTC1_WAVE0_OUT ]
  set TTC1_WAVE1_OUT [ create_bd_port -dir O TTC1_WAVE1_OUT ]
  set TTC1_WAVE2_OUT [ create_bd_port -dir O TTC1_WAVE2_OUT ]
  ...
  connect_bd_net -net processing_system7_0_TTC0_WAVE0_OUT [get_bd_ports TTC0_WAVE0_OUT] [get_bd_pins processing_system7_0/TTC0_WAVE0_OUT]
  connect_bd_net -net processing_system7_0_TTC0_WAVE1_OUT [get_bd_ports TTC0_WAVE1_OUT] [get_bd_pins processing_system7_0/TTC0_WAVE1_OUT]
  connect_bd_net -net processing_system7_0_TTC0_WAVE2_OUT [get_bd_ports TTC0_WAVE2_OUT] [get_bd_pins processing_system7_0/TTC0_WAVE2_OUT]
  connect_bd_net -net processing_system7_0_TTC1_WAVE0_OUT [get_bd_ports TTC1_WAVE0_OUT] [get_bd_pins processing_system7_0/TTC1_WAVE0_OUT]
  connect_bd_net -net processing_system7_0_TTC1_WAVE1_OUT [get_bd_ports TTC1_WAVE1_OUT] [get_bd_pins processing_system7_0/TTC1_WAVE1_OUT]
  connect_bd_net -net processing_system7_0_TTC1_WAVE2_OUT [get_bd_ports TTC1_WAVE2_OUT] [get_bd_pins processing_system7_0/TTC1_WAVE2_OUT]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
